...
public:
     ...
     *
     * @param node BasePointer to the node whose subtree to check
     ...
     * @brief Get the pointer to the node containing the least value in the subtree
     *
     * @param node ConstBasePointer to the whose subtree to check
     ...
     * @brief Get the pointer to the node containing the greatest value in the subtree
     *
     * @param node ConstBasePointer to the node whose subtree to check
     ...
     *
     * @param node BasePointer to the node whose value to increment
     ...
     *
     * @param node ConstBasePointer to the node whose value to decrement
     ...
     * @brief Decrement the node's value by 1
     *
     * @param node BasePointer to the node whose value to decrement
     * @return BasePointer to the decremented node
     */
